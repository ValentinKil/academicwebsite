...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/academicwebsite/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("bluesky_url", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6E%61%6D%65.%73%75%72%6E%61%6D%65@%75%6E%69%76%65%72%73%69%74%79.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/linkedin_username", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=0000AAAAAaaaaa", "_blank");
        },
      },{
      id: 'light-theme',
